  ...
  return (
    <div ref={containerRef} className="relative h-[440px] w-full overflow-hidden sm:h-[600px] lg:h-[640px]">
      ...
      <Globe
        ...
        pointsData={points}
        pointLat={(point: object) => (point as CountryPoint).lat}
        pointLng={(point: object) => (point as CountryPoint).lng}
        ...
        ringLat={(point: object) => (point as CountryPoint).lat}
        ringLng={(point: object) => (point as CountryPoint).lng}
        ringColor={() => "#dfff75"}
        ringMaxRadius={3.4}
